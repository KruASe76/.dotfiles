if status is-interactive
    ...
    abbr -a pc-amn 'proxychains -q -f ~/.config/proxychains/amnezia.conf'
    abbr -a pc-usa 'proxychains -q -f ~/.config/proxychains/usa.conf'
    abbr -a pc-ind 'proxychains -q -f ~/.config/proxychains/india.conf'
    abbr -a pc-vi 'proxychains -q -f ~/.config/proxychains/vietnam.conf'
